    ...
    <div className="container-fluid">
      <div className="row justify-content-center rowp" style ={{background:'#001129',}}>
       <form className="form-inline">
          ...
          <button className="btn" style ={{background:'#1160ba',color:'#0f1d3b',border:'#001129'}}>Check bus</button>
       </form>
       </div>
     </div>
     <div className="container-fluid servp">
      <div className="row">
        <div className="col-md-12 text-center" style ={{background:'#012240',color:'#2f7fd8'}}><h3>SERVICES</h3></div>
     ...
     <div className="container-fluid aboutp">
        <div className="row">
          <div className="col-md-12 text-center" style ={{background:'#012240',color:'#2f7fd8'}}><h3>ABOUT US</h3></div>
     ...
     <div className="container-fluid aboutp">
      <div className="row justify-content-md-center">
          <div className="col-md-12 text-center" style ={{background:'#012240',color:'#2f7fd8'}}><h3>CONTACT</h3></div>
